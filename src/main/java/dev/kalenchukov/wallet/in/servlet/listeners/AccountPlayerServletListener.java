...
import dev.kalenchukov.wallet.in.servlet.AccountPlayerServlet;
 ...
 */
@WebListener
public class AccountPlayerServletListener implements ServletContextListener {
	/**
	 * {@inheritDoc}
	 *
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		context.addServlet("AccountPlayerServlet", new AccountPlayerServlet(
