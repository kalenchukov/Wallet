...
import dev.kalenchukov.wallet.in.servlet.OperationAccountPlayerServlet;
 ...
 */
@WebListener
public class OperationPlayerServletListener implements ServletContextListener {
	/**
	 * {@inheritDoc}
	 *
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		context.addServlet("OperationAccountPlayerServlet", new OperationAccountPlayerServlet(
		...
		)).addMapping("/players/accounts/operations");
	}
}
