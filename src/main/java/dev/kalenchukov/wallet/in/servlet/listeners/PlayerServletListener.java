...
import dev.kalenchukov.wallet.in.servlet.PlayerServlet;
 ...
 */
@WebListener
public class PlayerServletListener implements ServletContextListener {
	/**
	 * {@inheritDoc}
	 *
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		context.addServlet("PlayerServlet", new PlayerServlet(
