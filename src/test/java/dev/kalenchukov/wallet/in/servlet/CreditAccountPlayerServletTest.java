...
public class CreditAccountPlayerServletTest {
	...
	public class DoPost {
		/**
		 * Проверка метода {@link CreditAccountPlayerServlet#doPost(HttpServletRequest, HttpServletResponse)}.
		 */
		@Test
		public void doPost() throws IOException, NotFoundAccountException, NoAccessAccountException, NegativeAmountOperationException {
			String inputData = "{" +
					"\"accountId\":1," +
					"\"amount\":99.9," +
			...
			when(ACCOUNT_SERVICE.credit(anyLong(), anyLong(), any(BigDecimal.class))).thenReturn(operation);

			CreditAccountPlayerServlet servlet = new CreditAccountPlayerServlet(ACTION_SERVICE, ACCOUNT_SERVICE);
			...
			verify(ACCOUNT_SERVICE, times(1)).credit(anyLong(), anyLong(), any(BigDecimal.class));
		 ...
		 */
		@Test
		public void doPostWithUnnecessaryParamInputData() throws IOException, NotFoundAccountException, NoAccessAccountException, NegativeAmountOperationException {
			String inputData = "{" +
		 ...
		 */
		@Test
		public void doPostWithNotFoundAccount() throws IOException, NotFoundAccountException, NoAccessAccountException, NegativeAmountOperationException {
			String inputData = "{" +
					"\"accountId\":164689," +
					"\"amount\":99.9," +
					"\"accessToken\":\"eyJhbGciOiJI6IkpX9.eyJpc3MiOixMzU3NjB9.B461wQdfLGHkQflFAQ\"" +
			...
			when(INPUT_STREAM.readAllBytes()).thenReturn(inputData.getBytes());
			when(RESPONSE.getWriter()).thenReturn(PRINT_WRITER);
			when(ACCOUNT_SERVICE.credit(anyLong(), anyLong(), any(BigDecimal.class)))
		 ...
		 */
		@Test
		public void doPostWithNoAccessAccount() throws IOException, NotFoundAccountException, NoAccessAccountException, NegativeAmountOperationException {
			String inputData = "{" +
					"\"accountId\":164689," +
					"\"amount\":99.9," +
					"\"accessToken\":\"eyJhbGciOiJI6IkpX9.eyJpc3MiOixMzU3NjB9.B461wQdfLGHkQflFAQ\"" +
		...
		/**
		 * Проверка метода {@link CreditAccountPlayerServlet#doPost(HttpServletRequest, HttpServletResponse)}
		 * отрицательной суммой операции.
		 */
		@Test
		public void doPostWithNegativeAmount() throws IOException, NotFoundAccountException, NoAccessAccountException, NegativeAmountOperationException {
			String inputData = "{" +
					"\"accountId\":1," +
					"\"amount\":-88.8," +
					"\"accessToken\":\"eyJhbGciOiJI6IkpX9.eyJpc3MiOixMzU3NjB9.B461wQdfLGHkQflFAQ\"" +
